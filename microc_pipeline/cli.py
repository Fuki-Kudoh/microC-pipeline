"""CLI for the v0.5.1 config-driven single-sample Micro-C runner."""
...
from .runner import RunnerError, run_pipeline, validate_and_write_manifest, validate_preflight_inputs
...
def command_validate_config(args: argparse.Namespace) -> int:
    ...
    validate_preflight_inputs(config)
